...
function (a, b) {
	...
	$.each("dark light gray red green blue lightyellow lightblue lightpink".split(" "), function (a, b) {
	    X.Skins[b] = {}
	});
    var Y = function (a) {
        function b(b) {
	...
	Bounds = {
	    viewport: function () {
	        var a;
	        return a = Y.MobileSafari || Y.Android && Y.Gecko ? {
    ...
    var ba = {
        create: function () {
            ...
            function c(a) {
                var b, c;
                return b = a.behavior && (c = X.Behaviors[a.behavior]) ? deepExtend($.extend({},
				c), a) : a
            }
            function d(a) {
                ...
                i.position = k;
                var o;
                if ("mouse" == i.target ? (o = $.extend({},
				e.offset), $.extend(o, X.Skins.reset.offset || {}), a.skin && $.extend(o, (X.Skins[a.skin] || X.Skins[bb.options.defaultSkin] || {}).offset || {}), o = Position.adjustOffsetBasedOnPosition(e.offset, e.position, k.target, !0), a.offset && (o = $.extend(o, a.offset || {}))) : o = {
                    x: i.offset.x,
                    y: i.offset.y
                },
    ...
    var bb = {
        ...
        init: function () {
			...
			Y.MobileSafari && $("body").bind("click", this._emptyClickHandler)
        },
        reset: function () {
            bb.removeAll(),
			bd.removeAll(),
			this._resizeHandler && $(window).unbind("resize orientationchange", this._resizeHandler),
			Y.MobileSafari && $("body").unbind("click", this._emptyClickHandler)
        },
	...
	$.extend(Tooltip.prototype, {
	    ...
	    initialize: function (a, b) {
	        if (this.element = a, this.element) {
	            ...
	            d && (c = deepExtend($.extend({},
				c), eval("({" + d + "})"))),
				this.options = ba.create(c),
				this._cache = {
				    dimensions: {
				        width: 0,
				        height: 0
	            ...
	            if (!b) {
	                ...
	                if (f ? b = f : e && (b = e), b) {
	                    var g = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi;
	                    b = b.replace(g, "")
	                }
	            }
	            if ((!b || b instanceof $ && !b[0]) && !(this.options.ajax && this.options.ajax.url || this.options.inline)) return this._aborted = !0,
				void 0;
	            e && ($(a).data("tipped-restore-title", e), $(a)[0].setAttribute("title", "")),
				this.content = b,
				this.title = $(this.element).data("tipped-title"),
				"undefined" != $.type(this.options.title) && (this.title = this.options.title),
				this.zIndex = this.options.zIndex || +bb.options.startingZIndex;
	            var h = $(a).data("tipped-uids");
	            h || (h = []);
	            var i = getUID();
	            this.uid = i,
				h.push(i),
				$(a).data("tipped-uids", h);
	            var j = $(this.element).closest(".tpd-tooltip")[0],
				parentTooltip;
	            j && (parentTooltip = bb.getTooltipByTooltipElement(j)) && parentTooltip.is("nest", !0);
	            var k = this.options.target;
	            this.target = "mouse" == k ? this.element : "element" != k && k ? _.isElement(k) ? k : k instanceof $ && k[0] ? k[0] : this.element : this.element,
	    ...
	    remove: function () {
	        ...
	        if (b > -1 && (a.splice(b, 1), $(this.element).data("tipped-uids", a)), a.length < 1) {
	            ...
	            (c = $(this.element).data(d)) && ("" != !$(this.element)[0].getAttribute("title") && $(this.element).attr("title", c), $(this.element).removeData(d)),
	    ...
	    preBuild: function () {
	        ...
	        this._tooltip = $("<div>").addClass("tpd-tooltip").addClass("tpd-skin-" + this.options.skin).addClass("tpd-size-" + this.options.size).css(a).hide(),
			this.createPreBuildObservers()
	    },
	    build: function () {
	        this.is("build") || (this.attach(), Y.IE && Y.IE < 7 && this._tooltip.append(this.iframeShim = $("<iframe>").addClass("tpd-iframeshim").attr({
	            frameBorder: 0,
	            src: "javascript:'';"
	    ...
	    createPreBuildObservers: function () {
			...
			this.bind(this._tooltip, "mouseenter", this.setActive),
			this.bind(this.element, "mouseleave", function (a) {
			    this.setIdle(a)
			}),
			...
			this)),
			this.options.hideOnClickOutside && ($(this.element).addClass("tpd-hideOnClickOutside"), this.bind(document.documentElement, Support.touch ? "touchend" : "click", $.proxy(function (a) {
			    if (this.visible()) {
			...
			a && this.bind(this.element, "mousemove", function () {
	...
	$.extend(Tooltip.prototype, {
	    ...
	    show: function () {
	        if (this.clearTimer("hide"), !this.visible() && !this.is("disabled") && $(this.target).is(":visible")) {
				...
				this)),
				this.options.hideAfter && a.queue($.proxy(function () {
				    this.setActive()
				},
				this))
	        }
	    ...
	    _show: function (a, b) {
			...
			this.options.hideOthers && bb.hideAll(this),
	        ...
	        if (!this.is("updating")) {
	            ...
	            switch (this._contentWrapper.css({
	                ...
	                case "ajax":
	                    ...
	                    var i = $.extend({},
                        h, d);
	                    $.each("complete error success".split(" "), $.proxy(function (b, c) {
	                        i[c] || (i[c] = "success" == c ?
                            function (a, b, c) {
                                return c.responseText
                            } : function () { }),
                            i[c] = _.wrap(i[c], $.proxy(function (b) {
                                var d = _slice.call(arguments, 1),
                                e = $.type("object" == d[0]) ? d[0] : d[2];
                                if (!e.statusText || "abort" != e.statusText) {
                                    this.options.cache && Z.set({
                                        url: i.url,
                                        type: i.type,
                                        data: i.data
                                    },
                        ...
                        this));
	                    var j;
	                    if (this.options.cache && (j = Z.get(i)) && j.callbacks.success) return $.each(j.callbacks, $.proxy(function (a, b) {
	                        "function" == $.type(i[a]) && i[a].apply(this, b)
	                    },
                        this)),
                        void 0;
	                    this.startLoading(),
                        this._cache.xhr = $.ajax(i)
	            }
	        }
	    },
...
(i[b] = this.isSideWithinContainment(b, c, !0)) && (h = !0)
	...
	$.extend(X, {
	    ...
	    create: function (a, b, c) {
	        return Collection.create(a, b, c),
			this.get(a)
	    },
	    get: function (a) {
	    ...
	    setDefaultSkin: function (a) {
	        return bb.setDefaultSkin(a),
			this
	    },
	    visible: function (a) {
	        if (_.isElement(a)) return bb.isVisibleByElement(a);
	        if ("undefined" != $.type(a)) {
	            var b = $(a),
				c = 0;
	            return $.each(b, function (a, b) {
	                bb.isVisibleByElement(b) && c++
	            }),
				c
	        }
	        return bb.getVisible().length
	    },
	    clearAjaxCache: function () {
	        return bb.clearAjaxCache(),
			this
	    },
	    refresh: function (a, b, c) {
	        return bb.refresh(a, b, c),
			this
	    },
	    setStartingZIndex: function (a) {
	        return bb.setStartingZIndex(a),
			this
	    }
	}),
	$.each("remove show hide toggle disable enable".split(" "), function (a, b) {
	    X[b] = function (a) {
	        return this.get(a)[b](),
			this
	    }
	...
	$.extend(X, {
	    delegate: function () {
	        bd.add.apply(bd, _slice.call(arguments))
	    },
	    undelegate: function () {
	        bd.remove.apply(bd, _slice.call(arguments))
	    }
	});
    var bd = {
        _uid: 0,
        ...
        add: function (a, b, c) {
            var c;
            "object" != $.type(b) || _.isElement(b) ? c = arguments[2] || {} : (c = b, b = null);
            var d = ++this._uid,
			e = ba.create($.extend({},
			c));
            this._delegations[d] = {
            ...
            var f = function (a) {
                $(this).addClass("tpd-delegation-uid-" + d);
                var e = new Tooltip(this, b, c);
                e._cache.event = a,
				e.setActive(),
				e.showDelayed()
            };
            this._delegations[d].removeTitleHandler = $.proxy(this.removeTitle, this),
			$(document).delegate(a + ":not(.tpd-delegation-uid-" + d + ")", "mouseenter", this._delegations[d].removeTitleHandler),
			this._delegations[d].handler = f,
			$(document).delegate(a + ":not(.tpd-delegation-uid-" + d + ")", e.showOn.element, f)
        },
        removeTitle: function (a) {
            var b = a.currentTarget,
			c = $(b).attr("title");
            c && ($(b).data("tipped-restore-title", c), $(b)[0].setAttribute("title", ""))
        },
        remove: function (a) {
            $.each(this._delegations, $.proxy(function (b, c) {
                c.selector == a && ($(document).undelegate(a + ":not(.tpd-delegation-uid-" + b + ")", "mouseenter", c.removeTitleHandler).undelegate(a + ":not(.tpd-delegation-uid-" + b + ")", c.options.showOn.element, c.handler), delete this._delegations[b])
            },
			this))
        },
        removeAll: function () {
            $.each(this._delegations, $.proxy(function (a, b) {
                $(document).undelegate(selector + ":not(.tpd-delegation-uid-" + a + ")", "mouseenter", b.removeTitleHandler).undelegate(b.selector + ":not(.tpd-delegation-uid-" + a + ")", b.options.showOn.element, b.handler),
				delete this._delegations[a]
            },
			this))
        }
    };
	...
	$.extend(Collection.prototype, {
	    items: function () {
	        return bb.get(this.element, {
	            api: !0
	        })
	    },
	    refresh: function (a) {
	        return bb.refresh(this.element, a),
			this
	    },
	    remove: function () {
	        return bb.remove(this.element),
			this
	    }
	}),
	$.each("show hide toggle disable enable".split(" "), function (a, b) {
